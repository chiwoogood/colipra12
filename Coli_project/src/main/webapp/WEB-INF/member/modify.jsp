			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="left-content">
						...
						<form id="form-contact" class="form-light" action="">
							<p>
								<input type="text" name="password" placeholder="비밀번호수정" required>
							</p><p>
								<input type="text" name="password_repeat" placeholder="비밀번호확인" required>
							</p>
							<p>
								<input type="text" name="nickname" placeholder="닉네임 수정" required>
							</p>
							<p>
								<input type="text" name="phone" placeholder="핸드폰 번호 변경" required>
							</p>
				...
				<div class="col-md-6">
					<div class="right-content">
						...
						<div class="iconbox">
							<img src="${cpath}/images/image/id.png">
							<div class="detail">
								<strong>ID:</strong>
								<p>${member.id}</p>
							</div>
